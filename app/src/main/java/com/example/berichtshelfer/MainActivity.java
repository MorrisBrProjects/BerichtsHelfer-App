package com.example.berichtshelfer;
...
import com.example.berichtshelfer.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // System.out.println(new Networking().getAllBericht());
        //System.out.println(new Networking().getAllBericht());
        //BerichtService.saveListOfBerichts(net.getAllBericht());
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_berichte, R.id.nav_gallery, R.id.nav_slideshow)
    ...
    public void openView(Class viewClass) {
        startActivity(new Intent(MainActivity.this, viewClass));
    }
